...
from script_adjustments import *
...
HeadlineChecker(demo_items=items_file_path, demo_practice=practice_file_path, include_context=context_answer,
...
# Create and write the custom code to a txt file
with open("config.json", "r", encoding='utf-8') as config_file:
    config_dict = json.load(config_file)
write_script(config_dict)
